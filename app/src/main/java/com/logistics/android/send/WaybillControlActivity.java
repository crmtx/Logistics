...
public class WaybillControlActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_waybill_control);
    ...
    public void click(View view) {
        switch (view.getId()) {
            case R.id.back_button:
                Intent backIntent = new Intent(WaybillControlActivity.this, WaybillAddActivity.class);
            ...
            case R.id.ok_button:
                ...
                List<Waybill> waybillList = DataSupport.where("id = ?", waybill_id).find(Waybill.class);
                Waybill waybill = waybillList.get(0);
                waybill.setStatus(1); //订单状态设为已发货
                waybill.setCar(car);
                waybill.setUser(user);
                waybill.save();

                Toast.makeText(WaybillControlActivity.this, "订单加入成功", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(WaybillControlActivity.this, WaybillAddActivity.class);
